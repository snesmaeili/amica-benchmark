#!/bin/bash
#SBATCH --job-name=heldout_ds004505
...
#SBATCH --output=/home/sesma/scratch/heldout_ds004505_%a_%j.out
#SBATCH --error=/home/sesma/scratch/heldout_ds004505_%a_%j.err
#
...
OUT_DIR="${HELDOUT_RESULTS_DIR:-/scratch/$USER/amica_heldout_cv/ds004505}"
mkdir -p "$OUT_DIR"
