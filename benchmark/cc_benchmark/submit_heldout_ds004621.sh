#!/bin/bash
#SBATCH --job-name=heldout_ds004621
...
#SBATCH --output=/home/sesma/scratch/heldout_ds004621_%a_%j.out
#SBATCH --error=/home/sesma/scratch/heldout_ds004621_%a_%j.err
#
...
OUT_DIR="${HELDOUT_RESULTS_DIR:-/scratch/$USER/amica_heldout_cv/ds004621}"
mkdir -p "$OUT_DIR"
