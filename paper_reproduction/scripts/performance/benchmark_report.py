...
Usage:
  python scripts/performance/benchmark_report.py --dataset {mne,mobi} --device {cpu,gpu} --seed N [--chunk_size K]

Writes JSON to results/benchmark_report/<dataset>_<device>_seed<N>_chunk<K>.json
...
if args.dataset == "mne":
    ...
    PREPROC = Path("results/post_f1_audit/sub01_preproc.npz")
