...
FDIR = Path("results/post_f1_audit/fortran_output")
...
# Load raw data
z = np.load("results/post_f1_audit/sub01_preproc.npz", allow_pickle=True)
...
print(f"{'='*70}")
fortran_log = Path("results/post_f1_audit/fortran_20iter.log")
