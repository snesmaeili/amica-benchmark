...
Usage: python -u scripts/real_eeg/audit_post_f1_direct.py
"""
...
from scripts.comparison.run_highdens_validation import load_and_preprocess, determine_n_components
from amica_python import Amica, AmicaConfig

OUT_DIR = Path("results/post_f1_audit")
...
print(f"\n{'='*60}")
print("BASELINE (pre-F1, results/amica_result.pkl)")
print("="*60)
base_pkl = Path("results/amica_result.pkl")
if base_pkl.exists():
